...
export default function HomeSection(): React.JSX.Element {
    return (
        <div className="text-[16px]">
            <div className="flex flex-row gap-[25px] mb-[13px]">
                <p>Home</p>
                <p>Project</p>
                <p>Writing</p>
            </div>
            ...
            <div className="my-[35px] flex flex-col gap-[20px] ">
                <div>
                    <p>I build some projects to help me learn new things and also to help other. Follow my journey build in public here.
                    </p>
                </div>
                <div className="flex flex-row gap-[25px]">
                    {/* Cards */}
                    <div className=" flex flex-col gap-[10px]">
                        <div className=" h-[200px] rounded-[10px] bg-gray-400">
            ...
            <div className="py-15 pl-2">
                <div className="ml-[3px] -mb-[15px] h-8 w-[3px] bg-slate-950/10 dark:bg-white/10 rounded-t">
                </div>
                <div className="flex items-top">
                    <div className="relative">
                        <div className="w-[9px] h-[9px] mt-[6px] rounded-full bg-slate-600 dark:bg-white/90 relative">
                            <div className="bg-slate-900 dark:bg-white/90 animate-ping w-[9px] h-[9px] rounded-full absolute">
                            </div>
            ...
            <div className="border-[1px] border-gray-300 rounded-2xl p-5 my-10">
                ...
                <div className="flex flex-row items-center gap-5">
                    <textarea className="border-gray-300 h-full w-full rounded-md  border-[1px]"></textarea>
